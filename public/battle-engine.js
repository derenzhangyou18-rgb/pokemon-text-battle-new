...
function chooseEnemyMove(b){
  ...
  // 相手の技が空・壊れたデータでもターン処理を止めない。
  return usable[Math.floor(Math.random()*usable.length)] || {id:"tackle",name:"たいあたり",type:"ノーマル",power:40,category:"physical",priority:0,target:"opponent",accuracy:100};
}
...
function runTurn(b,playerMoveId){
  ...
  const em=chooseEnemyMove(b) || {id:"tackle",name:"たいあたり",type:"ノーマル",power:40,category:"physical",priority:0,target:"opponent",accuracy:100};
  prepareTurn(b);
